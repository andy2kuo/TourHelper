@echo off
chcp 65001 >nul
REM TourHelper Backend Service startup script
REM This script starts the backend service with customizable service name, version, and environment
...
echo ====================================
echo TourHelper Backend Service
echo ====================================
echo.

REM Prompt user for service name (default: backend_server)
set /p SERVICE_NAME="Enter Service Name [backend_server]: "
if "%SERVICE_NAME%"=="" set SERVICE_NAME=backend_server
...
go run -ldflags "%LDFLAGS%" cmd\backend\main.go
