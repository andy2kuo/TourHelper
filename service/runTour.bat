@echo off
chcp 65001 >nul
REM TourHelper Tour Service startup script
REM This script starts the tour service with customizable service name, version, and environment
...
echo ====================================
echo TourHelper Tour Service
echo ====================================
echo.

REM Prompt user for service name (default: tour_server)
set /p SERVICE_NAME="Enter Service Name [tour_server]: "
if "%SERVICE_NAME%"=="" set SERVICE_NAME=tour_server
...
go run -ldflags "%LDFLAGS%" cmd\tour\main.go
